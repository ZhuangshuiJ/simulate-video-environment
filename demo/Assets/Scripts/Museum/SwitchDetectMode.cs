...
public class SwitchDetectMode : MonoBehaviour
{
    ...
    [SerializeField] HeadRaycaster headRaycaster;
    [SerializeField] GyroControl gyroControl;
    #endregion
...
#region Private Method
    private void ObjSetup()
    {
        ...
        gripPoint = GameObject.Find("GripPoint");
        if (gripPoint == null)
        {
        ...
        detector = GameObject.Find("GripPoint/Cane/Detector");
        if (detector == null)
        {
        ...
        secDetector = GameObject.Find("GripPoint/Cane/SecDetector");
        if (secDetector == null)
        {
    ...
    public void SwitchButtonOnclick()//Onclick event for button
    {
        ...
        else
        {
            ...
            if(headRaycaster.lastArtifact != null)
            {
        ...
        gyroControl.initialCaneRotation();
    }
    #endregion
}
